  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.my-4.fondo-29.align-items-center.px-4
      ...
      .col-lg-11.col-md-9.col-sm-12.py-4(data-aos="fade-down-left")
        ...
        p.mb-0 Los sistemas fotovoltaicos autónomos están diseñados para cubrir completamente la demanda de electricidad de un lugar durante todo el tiempo, sin necesidad de utilizar una conexión a la red de electricidad convencional suministrada por los comercializadores de energía.
      ...
      .col-12
        .row.justify-content-center.mb-4
          ...
          .col-lg-10.col-md-12(data-aos="fade-down-right")
            ...
            p Subsistema de medición: se compone de un medidor de energía denominado como bidireccional. Internamente el medidor funciona como uno convencional, sin embargo, a diferencia de este, tiene la capacidad de medir y discriminar la cantidad de energía que viene de la red convencional y la cantidad de energía que viene desde el sistema fotovoltaico, con el fin de determinar al final del mes (o en cualquier momento) cuánta energía que viene de la red convencional debe facturar el comercializador de energía al usuario.
        ...
        .tarjeta.color-primario.p-3.mb-5
          .row.justify-content-around.align-items-center
            ...
            .col-sm-10.col-12
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0.text-white
                  p.text-bold.mb-0 Sistema Fotovoltaico Conectado a Red - On Grid
                .col-sm-auto
    ...
    p.mb-5(data-aos="fade-down-right") Actualmente existen varias herramientas software para el diseño de los sistemas fotovoltaicos. Revisar la siguiente información para que se estudie el tipo de herramientas que lo componen.
