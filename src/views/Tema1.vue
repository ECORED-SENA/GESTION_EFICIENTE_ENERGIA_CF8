  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.fondo-2.ampliar.px-5
      ...
      .row.justify-content-center.fondo-blanco.redondearpuntas.sombras.p-4.my-5
        ...
        .col-lg-3.col-md-6.col-sm-12(data-aos="fade-down-right")
          .row.justify-content-center.align-items-center
            .col-12(data-aos="fade-down-right")
        ...
        p.p-4.fondo-5.mb-0.desbordamiento(data-aos="fade-down-right") Nota. WIKA. (2021). ¿Cómo funcionan los manómetros mecánicos?. 
      ...
      .col-12
        ...
        .row.justify-content-center.align-items-center
          .col-lg-10.col-md-12.fondo-blanco.redondearpuntas.sombras.p-4
            ...
            .row.justify-content-center
              .col-lg-4.col-md-6.col-sm-12.mb-4(data-aos="fade-down-right")
                p.text-center Detalle constructivo de un sensor de temperatura Pt100
                img(src="@/assets/curso/tema1/figura3.svg")
              .col-lg-4.col-md-6.col-sm-12.mb-4(data-aos="fade-down-left")
    ...
    p.my-5(data-aos="fade-down-right") En el siguiente cuadro se muestran algunas características de las sondas RTD dependiendo del tipo de metal de construcción:
      ...
      .col-12
        ...
        .row.justify-content-center
          .col-lg-10.col-md-12.my-5.fondo-blanco.redondearpuntas.sombras.p-4
            ...
            .row.justify-content-center
              .col-lg-4.col-md-8.col-sm-12(data-aos="fade-down-right")
              ...
              .col-lg-8.col-md-10.col-sm-12(data-aos="fade-down-left")
    ...
    p.my-5(data-aos="fade-down-right") En el siguiente video se explica el funcionamiento del termómetro por radiación infrarroja y su aplicación durante la pandemia: 
    .row.justify-content-center
      .col-lg-10.col-md-12(data-aos="fade-down-right")
        .tarjeta.color-primario.p-3.mb-5
          .row.justify-content-around.align-items-center
              ...
              .row.justify-content-between.align-items-center
                ...
                .col-sm-auto
                  a.boton.color-acento-botones(:href="('https://www.youtube.com/watch?v=y-Ezb8Q5UW0')" target="_blank")
                    ...
                    i.fas.fa-link 
    separador
    #t_1_3.titulo-segundo.color-acento-botones(data-aos="fade-down-right")
      h2 1.3 Medición de nivel
    p.mb-5(data-aos="fade-down-left") Conocer la medición de nivel y sus diferentes procesos a continuación:
    .tarjeta.fondo-1.p-4.mb-5(data-aos="fade-down-right")
      SlyderA.my-5(tipo="b")
        .row.justify-content-center.align-items-center
          .col-lg-6.col-md-12.mb-4.mb-lg-0
    ...
    .row.justify-content-center
      .col-lg-10.col-md-12.fondo-14.p-5.redondearpuntas.sombras(data-aos="fade-down-right")
        p.fuente14.text-bold.text-center(data-aos="fade-down-right") La relación matemática que ilustra el principio de la presión hidrostática es:
        .row.justify-content-center
          .col-10.fondo-blanco.redondearpuntas.sombras.p-4.fuente14(data-aos="fade-down-left")
      ...
      .col-12
        ...
        .row.justify-content-center
          .col-lg-10.col-md-12.fondo-blanco.sombras.redondearpuntas.p-5
            .row.justify-content-between(data-aos="fade-down-left")
              .col-5
        ...
        p.my-5(data-aos="fade-down-left") Explorar las características generales de los instrumentos de medición.
        .tarjeta.fondo-1.p-4.mb-5(data-aos="fade-down-right")
          SlyderA.my-5(tipo="b")
            .row.justify-content-center.align-items-center
              .col-lg-6.col-md-12.mb-4.mb-lg-0
